...
public class CorrectMoveServlet extends HttpServlet
{
    ...
    {
        // http://localhost:8080/PegSolitaire-1.0-SNAPSHOT/correctMove?boardString=011111111111111&startingIndex=0
        ...
        TriangleBoardTree.TriangleTreeNode node = possibleBoardTrees.getAllGameBoards()[0]
                .getFound().get(board);
        List<TriangleBoard> children = node.getChildren().stream()
